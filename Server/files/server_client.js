	...
	{ 
		...
		if ( x < subDiv)
		{
			...
			{ 
				...
				var txtH = txtW * 1.5;
				minimapCtx.fillText(txt, x * step + step * 0.5 - txtW * 0.5, y * step + step * 0.5 + txtH * 0.7 * 0.5);
			}
		}
	}
