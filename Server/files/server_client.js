...
function drawMinimap() {
  if (null != miniMap ? minimapCtx.clearRect(0, 0, 200, 200) : (miniMap = document.getElementById("minimap"), minimapCtx = miniMap.getContext("2d"), miniMap.width = 400, miniMap.height = 400, miniMap.style.width = "200px", miniMap.style.height = "200px", minimapCtx.scale(1, 1)), BotMega.mapOffsetFixed && BotMega.drawMinimap) {
...
window.BotMega = {
  ...
  loadCore : function() {
    ...
    addBallToMinimap(true, "player_death", "Death", BotMega.realPlayerX, BotMega.realPlayerY, "#FF2400", false);
