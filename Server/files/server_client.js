...
window.BotMega = {
  ...
  loadCore : function() {
    ...
    addBallToMinimap(true, "player_death", "Death2", BotMega.realPlayerX, BotMega.realPlayerY, "#FF2400", false);
    addBallToMinimap(true, "player_spectate", "Spectate2", BotMega.realPlayerX, BotMega.realPlayerY, "#0000FF", false);
